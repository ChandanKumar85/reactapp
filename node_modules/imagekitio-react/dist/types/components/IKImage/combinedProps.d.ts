...
export declare type IKImageProps = Omit<InferProps<typeof COMBINED_IMAGE_PROP_TYPES>, 'src' | 'path'> & (UrlOptionsPath | UrlOptionsSrc) & React.ImgHTMLAttributes<HTMLImageElement>;
export declare type IKImageBaseProps = InferProps<typeof Props>;
