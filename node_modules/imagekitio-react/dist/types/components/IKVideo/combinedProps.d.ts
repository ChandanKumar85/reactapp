...
export declare type IKVideoProps = Omit<InferProps<typeof COMBINED_IMAGE_PROP_TYPES>, 'src' | 'path'> & (UrlOptionsPath | UrlOptionsSrc) & React.VideoHTMLAttributes<HTMLVideoElement>;
export declare type IKVideoBaseProps = InferProps<typeof Props>;
